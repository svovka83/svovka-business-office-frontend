  ...
  return (
    <div className={styles.content}>
      ...
      <p className={styles.text}>
        ...
        використовуючи module, бібліотеками react-animate-on-scroll, animate.css
        та Material UI. Також за допомогою останнього адаптував на пристрої з
        різним розширенням. Деплой бекенду зробив на платформу Render, фронтенду
        - на Netlify.
      </p>
      <p>
        <a
